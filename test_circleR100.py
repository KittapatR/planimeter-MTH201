...
im=cv2.circle(np.ones((600,600,3),np.uint8),(300,300),100,(0,0,255),5)

imgray=cv2.cvtColor(im,cv2.COLOR_BGR2GRAY)
# imgray=im[:,:,2]
ret, thresh = cv2.threshold(imgray,30,255,1)
...
plt.text(50,-150,"Truly Drawing {}".format(np.round(np.pi*100*100,3)))
plt.show()
